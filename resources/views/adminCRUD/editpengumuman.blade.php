...
<head>
  ...
  <link href="{{ asset('css/editform.css') }}" rel="stylesheet" media="screen">
...
<body>
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <form action={{ url('editpengumuman/' .  $pengumumans->id ) }} method="post" enctype="multipart/form-data" style="padding-top: 75px;">
          {{ csrf_field() }}
          Judul Pengumuman:<br>
