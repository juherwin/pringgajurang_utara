...
<head>
  ...
  <link href="{{ asset('css/transparansi.css') }}" rel="stylesheet" media="screen">
...
<body>
        ...
        <span id="textlogo">Pringgajurang Utara</span>
          ...
          <div >
            <ul class="nav navbar-nav">
              <li class="current"><a href="{{url('/')}}">kembali</a></li>
    ...
    <section id="transparansi">
      <div class="container">
      <h1 class="text-center" style="text-transform: uppercase;">{{$id}} Desa Pringgajurang Utara Tahun Anggaran {{ $apbds[0]->tahun }}</h1>
      <div class="row">
        <div class="col-md-12">
